...
import com.honor.e2b.core.common.constant.DefaultAvatar;
...
import com.honor.e2b.modular.system.service.FileInfoService;
import com.honor.e2b.modular.system.service.NoticeService;
...
public class SystemController extends BaseController {
    ...
    public Object uploadAvatar(@RequestParam("file") MultipartFile file) {
        String avatar = null;
        try {
            avatar = Base64.encode(file.getBytes());
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        fileInfoService.uploadAvatar(avatar.substring(avatar.indexOf(",") + 1));
        Map map = new HashMap();
        map.put("code", 1);
